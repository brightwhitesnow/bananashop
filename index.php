        ...
        <div class="footer-top">
            ...
            <div class="mid">
                <form id="contact" action="">
                    ...
                    <input id="phone" type="phone" placeholder="Your Phone Number" style="height: 50px;width: 70px;border-radius: 5px;">
                    <input id="email" type="email" placeholder="Your Email" required style="height: 50px;width: 70px;border-radius: 5px;">
